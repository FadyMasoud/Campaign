...
**Status: written, not yet applied.** The migration and the isolation test are
committed; neither has been run against the hosted project, so requirements 2
and 8 stay ◐ until `npm test` passes green.
